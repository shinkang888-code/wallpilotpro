...
export function DeepAgentReportScroll({
  ...
  return (
    ...
    >
      ...
      <section className="bg-primary/[0.02] p-4 sm:p-5">
        <p className="sticky top-0 z-10 -mx-4 -mt-4 mb-3 bg-primary/[0.02]/95 px-4 py-2 text-[10px] font-bold uppercase tracking-[0.2em] text-primary backdrop-blur sm:-mx-5 sm:px-5">
