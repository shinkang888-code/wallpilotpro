...
export function SignalHubPanel() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-12rem)] flex-col gap-6">
      ...
      {tossFrameOpen ? (
        <section className="mt-auto flex min-h-[50vh] flex-1 flex-col overflow-hidden rounded-2xl border border-[rgba(49,130,246,0.25)] bg-white shadow-sm">
